...
const CREDENTIAL_FIELDS: Record<string, { name: string; label: string; placeholder: string; type?: string }[]> = {
  shopee: [
    { name: 'partner_id',  label: 'Partner ID',  placeholder: 'ID do parceiro Shopee' },
  ...
  amazon: [
    ...
    { name: 'client_secret', label: 'LWA Secret',    placeholder: 'Login with Amazon Secret', type: 'password' },
