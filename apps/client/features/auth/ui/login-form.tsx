  ...
  return (
    <form action={formAction} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Input id="email" name="email" type="email" autoComplete="email" placeholder="seu@email.com" required disabled={isPending} aria-invalid={!!state?.error} />
      </div>
      ...
      <Link href="/api/auth/google/authorize" prefetch={false} aria-disabled={isPending} className="flex h-10 w-full items-center justify-center gap-2 rounded-md border border-input bg-background px-3 text-sm font-medium transition hover:border-foreground/30 hover:bg-muted aria-disabled:pointer-events-none aria-disabled:opacity-50">
        <GoogleMark />
