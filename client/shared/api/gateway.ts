...
export async function syncConnector(token: string, connectorName: string, since?: string): Promise<SyncJob> {
  ...
  if (!accepted.job_id) throw new Error('Resposta inválida ao iniciar sincronização.')
